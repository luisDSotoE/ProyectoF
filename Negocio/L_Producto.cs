...
namespace Negocio
{
    ...
    public class L_Producto
    {
        ...
        {
            return datosProducto.Insertar(producto);
        }
        /// <summary>
        ...
        {
            return datosProducto.CargarDatos(grilla);
        }
        /// <summary>
        ...
        {
            return datosProducto.Eliminar(idProducto);
        }
        /// <summary>
        ...
        {
            return datosProducto.Actualizar(producto);
        }
    }
}
